class ReceiptsController < ApplicationController
  ...
  def receipt_params
    params.require(:receipt).permit(:image_crop_x, :image_crop_y, :image_crop_w, :image_crop_h, :image, :image_cache, :store_id).merge({date: Chronic.parse(params[:receipt][:date]) || @receipt.date || @receipt.created_at})
  end
end
